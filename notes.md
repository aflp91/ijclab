...
via une page web unique. Le but est d'éviter le chargement d'une nouvelle page à chaque requête envoyée au serveur et 
ainsi fluidifier l'expérience utilisateur.
